 ...
 * TD S1 : Résoudre un problème du premier degré
 * mathilab/tp-algebre/js/tp01-resolution-probleme-premier-degre.js
 * ============================================================
 */
...
/**
 * Trace une demi-droite graduée : trait épais partant de la borne vers
 * -∞ ou +∞, avec un point plein (borne incluse) ou vide (borne exclue).
 */
...
/**
 * Trace un segment [a ; b] avec des points pleins ou vides selon que
 * chaque borne est fermée ou ouverte.
 */
...
const QUIZ_INTERVALLES = [
  {
    enonce: 'x ≥ −3',
    correcte: '[−3 ; +∞[',
    propositions: ['[−3 ; +∞[', ']−3 ; +∞[', ']−∞ ; −3]', ']−∞ ; −3[']
  },
  {
    enonce: 'x < 5',
    correcte: ']−∞ ; 5[',
    propositions: [']−∞ ; 5[', ']−∞ ; 5]', '[5 ; +∞[', ']5 ; +∞[']
  },
  {
    enonce: '−2 ≤ x < 4',
    correcte: '[−2 ; 4[',
    propositions: ['[−2 ; 4[', ']−2 ; 4[', '[−2 ; 4]', ']−2 ; 4]']
  },
  {
    enonce: 'x ≤ 0',
    correcte: ']−∞ ; 0]',
